...
class REST:
    ...
    def CreateSubAccount(self, friendlyName):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/SubAccounts?sig=" + sig
        # 生成auth
    ...
    def getSubAccounts(self, startNo, offset):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/GetSubAccounts?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def querySubAccount(self, friendlyName):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/QuerySubAccountByName?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def sendTemplateSMS(self, to, datas, tempId):
        ...
        # str转byte
        # bytes(src,"gbk")
        auth = base64.b64encode(src).strip()
        headers = {
    ...
    def sendTemplateSMSer(self, to, datas, tempId):
    ...
    def landingCall(self, to, mediaName, mediaTxt, displayNum, playTimes, respUrl, userData, maxCallTime, speed, volume,
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/Calls/LandingCalls?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def voiceVerify(self, verifyCode, playTimes, to, displayNum, respUrl, lang, userData):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/Calls/VoiceVerify?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def ivrDial(self, number, userdata, record):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/ivr/dial?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def billRecords(self, date, keywords):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/BillRecords?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def queryAccountInfo(self):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/AccountInfo?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def QuerySMSTemplate(self, templateId):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/SMS/QuerySMSTemplate?sig=" + sig
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def CallResult(self, callSid):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/CallResult?sig=" + sig + "&callsid=" + callSid
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def QueryCallState(self, callid, action):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/ivr/call?sig=" + sig + "&callid=" + callid
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
    ...
    def MediaFileUpload(self, filename, body):
        ...
        sig=hash.hexdigest().upper()
        # 拼接URL
        url = "https://" + self.ServerIP + ":" + int(self.ServerPort) + "/" + self.SoftVersion + "/Accounts/" + self.AccountSid + "/Calls/MediaFileUpload?sig=" + sig + "&appid=" + self.AppId + "&filename=" + filename
        # 生成auth
        src = self.AccountSid + ":" + self.Batch;
        auth = base64.encodestring(src).strip()
        req = request.Request(url)
